...
ActiveRecord::Schema.define(version: 20150821182911) do

  create_table "actor_directors", force: :cascade do |t|
    t.integer  "actor_id"
  ...
  add_index "directors", ["slug"], name: "index_directors_on_slug", unique: true
  ...
  create_table "movies", force: :cascade do |t|
    ...
    t.integer  "full_image_file_size"
